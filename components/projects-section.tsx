...
export function ProjectsSection() {
  ...
  return (
    <section className="section-shell section-pad projects-section" id="projects" aria-labelledby="projects-title">
      <div className="section-heading"><div><p className="eyebrow">01 / SELECTED WORK &amp; EXPLORATIONS</p><h2 id="projects-title">Ideas into reality.</h2></div><p>Research, real-world systems,<br />and things built out of curiosity.</p></div>
